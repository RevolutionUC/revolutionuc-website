export class Router {
  ...
  _swapContents() {
    ...
    const newMastHeadTitle = newMastHead.querySelector('div.masthead-title > h1');
    const newViewContent = this._newContent.querySelector('div[view]');

    // Strip and swap data
    this._mastHead.style.cssText = newMastHead.style.cssText;
    this._mastHead.querySelector('div.masthead-title > h1').innerText = newMastHeadTitle.innerText;
